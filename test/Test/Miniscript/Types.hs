...
import           Test.Tasty.QuickCheck               (Gen, forAll, testProperty,
                                                      (===))
...
import           Test.Miniscript.Examples            (example6, example7,
                                                      example8)
